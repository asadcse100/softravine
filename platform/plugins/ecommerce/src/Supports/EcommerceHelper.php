...
class EcommerceHelper
{
    ...
    public function getProductMaxPrice(int|string|null $categoryId = null): int
    {
        return Cache::remember(
            'ecommerce_product_price_range' . ($categoryId ? '_' . $categoryId : null),
            Carbon::now()->addHour(),
            function () use ($categoryId): int {
                $price = Product::query()
                    ->when($categoryId, function (BaseQueryBuilder $query) use ($categoryId): void {
                        $query
                            ->whereHas('categories', function (BaseQueryBuilder $query) use ($categoryId): void {
    ...
    public function brandsForFilter(int|string|null $categoryId = null): Collection
    {
    ...
    public function tagsForFilter(int|string|null $categoryId = null): Collection
    {
    ...
    public function dataForFilter(ProductCategory|null $category): array
    {
        ...
        $maxFilterPrice = $this->getProductMaxPrice($categoryId) * get_current_exchange_rate();
