        ...
        <div class="container product-details">
            <div class="row">
                ...
                <div class="col-lg-6 mb-30">
                    <h1 class="h3 font-bold-800 color-gray-800 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                        {{ $product->name }}
                    </h1>
                    ...
                    <div class="d-flex align-items-center mb-30 box-price-banner box-price">
                        @if ($product->front_sale_price === $product->price)
                            <h3 class="color-success mr-30 price">{{ format_price($product->front_sale_price_with_taxes) }}</h3>
                        @else
                            <h3 class="color-success mr-30 price">{{ format_price($product->front_sale_price_with_taxes) }}</h3>
                            <h4 class="color-grey-400 mr-30 price-line price-old">{{ format_price($product->price_with_taxes) }}</h4>
                        @endif
